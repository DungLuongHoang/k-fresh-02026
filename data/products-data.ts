...
// Type the catalogue as a literal `{ htcTouch: Product; canon: Product; ... }`
// rather than `Record<string, Product>`. With the latter, every `products.foo`
// access is `Product | undefined` under noUncheckedIndexedAccess AND triggers
// noPropertyAccessFromIndexSignature warnings in callers — fighting the type
// system for what is in fact a fixed, hand-curated catalogue. `satisfies Record<...>`
// keeps the structural contract while preserving the literal key set.
