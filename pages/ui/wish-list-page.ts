...
export class WishListPage extends WishListLocators {
  ...
  /**
   * Verify the browser landed on the Wishlist page (URL-based).
   * Useful for thin smoke tests that only need to confirm navigation worked
   * (e.g. clicking the wishlist icon in the header) without caring about the
   * page contents.
   */
  @step('Verify on Wishlist page')
  async verifyOnWishlistPage(): Promise<void> {
